package cc.hl.view.controlBar{
	...
	public class VideoProgressBar extends Sprite{
		...
		public static const NORMAL_HEIGHT:int = 2;
		public static const OVER_HEIGHT:int = 4;
		public static const SENSING_HEIGHT:int = 16;
		...
		public function setWidth(w:int):void{
			...
			this.drawSensingRange(SENSING_HEIGHT);
		}
		...
		protected function onMouseUp(e:MouseEvent):void{
			...
			dispatchEvent(new Event("CONTROL_BAR_SEEK_COMPLETE"));
		}

        protected function drawSensingRange(_arg1:int):void{
            this.graphics.clear();
            this.graphics.beginFill(0, 0);
            this.graphics.drawRect(0, (-((_arg1 - this._bar.height))), this._bar.width, _arg1);
